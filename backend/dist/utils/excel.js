...
class ExcelUtil {
     ...
     */
    static async generateProductsExcel(products) {
    ...
    static async generateLoansExcel(loans) {
        const workbook = new exceljs_1.default.Workbook();
    ...
    static async generateMovementsExcel(movements, title = 'Histórico de Movimentações') {
        const workbook = new exceljs_1.default.Workbook();
        workbook.creator = 'OmniStock Service Desk';
        workbook.created = new Date();
     ...
     */
    static async parseProductsImport(buffer) {
        const workbook = new exceljs_1.default.Workbook();
