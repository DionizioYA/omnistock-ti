...
class BarcodeUtil {
     ...
     */
    static generateBarcodeDataUrl(code) {
     ...
     */
    static generateQrCodeSvg(text, size = 150) {
...
exports.BarcodeUtil = BarcodeUtil;
